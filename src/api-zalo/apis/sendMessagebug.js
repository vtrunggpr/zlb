...
export function sendMessageFactoryv1(api) {
  const serviceURLs = {
    message: {
   ...
   * @throws {ZaloApiError}
   */
  return async function sendMessagev1(message, threadId, type = MessageType.DirectMessage) {
